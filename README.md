...
<p align="center">
  <a href="https://github.com/phys-playground-icons/phys-playground/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-ISC-green" alt="license"></a>
  <a href="https://www.figma.com/community/plugin/939567362549682242/phys-playground-Icons"><img src="https://img.shields.io/badge/Figma-F24E1E?logo=figma&logoColor=white" alt="figma installs"></a>
  <a href="https://github.com/phys-playground-icons/phys-playground/actions/workflows/ci.yml"><img src="https://github.com/phys-playground-icons/phys-playground/actions/workflows/ci.yml/badge.svg" alt="build status"></a>
...
The phys-playground Figma plugin.

Visit [Figma community page](https://www.figma.com/community/plugin/939567362549682242/phys-playground-Icons) to install the plugin.

<img width="420" src="https://www.figma.com/community/plugin/939567362549682242/thumbnail" alt="Figma phys-playground Cover">

## Contributing

For more info on how to contribute please see the [contribution guidelines](https://github.com/phys-playground-icons/phys-playground/blob/main/CONTRIBUTING.md).

Caught a mistake or want to contribute to the documentation? [Edit this page on Github](https://github.com/phys-playground-icons/phys-playground/blob/main/README.md)

## About brand logos

phys-playground **does not accept** brand logos, and we do not plan to add them in the future. This is due to a combination of **legal restrictions**, **design consistency concerns**, and **practical maintenance reasons**.

[Click here to read our official statement about brand logos in phys-playground.](./BRAND_LOGOS_STATEMENT.md)
...
phys-playground is totally free for commercial use and personal use, this software is licensed under the [ISC License](https://github.com/phys-playground-icons/phys-playground/blob/main/LICENSE).

## Credits

Thank you to all the people who contributed to phys-playground!

<a href="https://github.com/phys-playground-icons/phys-playground/graphs/contributors">

<img src="https://opencollective.com/phys-playground-icons/contributors.svg?width=800" />
</a>
...
<a href="https://vercel.com?utm_source=phys-playground&utm_campaign=oss">
...
You can find all our past and non-recurring financial contributors at [our Open Collective page](https://opencollective.com/phys-playground-icons).
